...
namespace supra
{
	...
	bool SupraManager::getFreezeTimerEnabled()
	{
		return m_freezeTimerEnabled.load();
	}

	void SupraManager::setFreezeTimerEnabled(bool enabled)
	{
		m_freezeTimerEnabled.store(enabled);
		resetFreezeTimeout();
	}
